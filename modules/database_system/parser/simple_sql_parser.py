"""
简化SQL解析器 - 不依赖sqlparse的复杂token类型
"""

import re
from typing import Any, Dict, List, Optional, Tuple
from ...src.utils.exceptions import SQLSyntaxError
...
class SimpleSQLParser:
    ...
    def _parse_create_table(self, sql: str) -> Dict[str, Any]:
        ...
        if not match:
            raise SQLSyntaxError("CREATE TABLE语句格式错误")
    ...
    def _parse_insert(self, sql: str) -> Dict[str, Any]:
        ...
        if not match:
            raise SQLSyntaxError("INSERT语句格式错误")
    ...
    def _parse_select(self, sql: str) -> Dict[str, Any]:
        ...
        if not match:
            raise SQLSyntaxError("SELECT语句格式错误")
    ...
    def _parse_delete(self, sql: str) -> Dict[str, Any]:
        ...
        if not match:
            raise SQLSyntaxError("DELETE语句格式错误")
